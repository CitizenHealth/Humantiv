...
export const HEALTH_SCORE_SAVE = "health_score_save";
...
export const TIMESERIES_MEDIT_FETCH = "timrseries_medit_fetch";
export const TIMESERIES_SCORE_FETCH = "timrseries_score_fetch";
